...
<div class="container">
       ...
       height: fit-content; width: 100%;">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title "style="text-align: center;">Questions of <?php echo $tbname; ?></h4>
            <?php
    while ($row1 = mysqli_fetch_array($retval)) {
?>
<div class="form">

<p> Question: <?php echo $row1['questions']; ?></p>
<p> Option1: <?php echo $row1['otp1']; ?></p>
<p> Option2: <?php echo $row1['otp2']; ?></p>
<p> Option3: <?php echo $row1['otp3']; ?></p>
<p> Option4: <?php echo $row1['otp4']; ?></p>
<p> Correct Answer: <?php echo $row1['correctans']; ?></p>
<form id="form" action="edit.php" method="POST">
<input type="hidden" name="tbname" value='<?php echo $tbname;?>'>
<input type="hidden" name="question" value='<?php echo $row1['questions'];?>'>
<button > Edit </button>
</input>
</form>
...
<hr style="height:2px;border-width:0;color:gray;background-color:gray">
 <span style="display:block; height: 5rem;"></span>
</div>
<?php
}
?>
...
<input type="hidden" name="name" value="  <?php echo $tbname ?>">
